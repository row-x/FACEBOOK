# দেক খানকীর পোলা এডিট করতে আইসে 😂😂😂
###################################################################
#                        Import Module
import json , sys , hashlib , os , time , marshal, getpass, base64
###################################################################
'''
...
\033[1;95m    /_/ |_/  /_/  |_/_/ /_/  /___/  /_____/  \033[1;92m
   ...
   ------------------------------------------""")
		...
		os.system("clear")
		exec(marshal.loads("c\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00@\x00\x00\x00s\t\x00\x00\x00d\x00\x00GHd\x01\x00S(\x02\x00\x00\x00s\xd4\x02\x00\x00\n\x1b[1;91m        _   __   ___    __  __   ____   ____ \n\x1b[1;92m       / | / /  /   |  / / / /  /  _/  / __ )\n\x1b[1;93m      /  |/ /  / /| | / /_/ /   / /   / / / /\n\x1b[0;96m     / /|  /  / ___ |/ __  /  _/ /   / /_/ / \n\x1b[1;95m    /_/ |_/  /_/  |_/_/ /_/  /___/  /_____/  \x1b[1;92m\n   ------------------------------------------\n   | \x1b[1;95mTOOLS NAME => \x1b[1;92mFACEBOOK INFO            |\n   | OWNER NAME => \x1b[1;92mNAHID AFRIDY             |\n   | \x1b[1;93mCLONE SYS  => \x1b[1;92mDATA , \x1b[1;91mWIFI      \x1b[1;92m        |\n   | WHATS APP  => \x1b[1;92m+8801923092304           |\n   | \x1b[0;96mFACEBOOK   => \x1b[1;92mwww.facebook.com/ERR0RS  |\n   |      \x1b[1;91mPLEASE DON'T UES A RONG WORK      \x1b[1;92m|\n   ------------------------------------------N(\x00\x00\x00\x00(\x00\x00\x00\x00(\x00\x00\x00\x00(\x00\x00\x00\x00s\x05\x00\x00\x00<roy>t\x08\x00\x00\x00<module>\x0e\x00\x00\x00t\x00\x00\x00\x00"))
        print (W + '     [' + G +'Open Source Information Facebook'+ W + ']')
        print (W + '     [' + G +'Any Problem Type To (admin)'+ W + ']')
        print (W + '     [' + G +'List Show Type To (help)'+ W + ']')
        print ' '
####################################################################
#		    Print In terminal
def show_program():

	exec(marshal.loads('c\x00\x00\x00\x00\x00\x00\x00\x00\x03\x00\x00\x00@\x00\x00\x00s\x13\x00\x00\x00d\x00\x00e\x00\x00e\x01\x00f\x02\x00\x16GHd\x01\x00S(\x02\x00\x00\x00s\xac\x01\x00\x00\n                    %sINFORMATION%s\n ------------------------------------------------------\n\n    Author     NAHID AFRIDY (MISTER MIND)\n    Name       FACEBOOK INFO \n    CodeName   NAHID AFRIDY\n    version    full version\n    Date       05/11/2022 09:35:12\n    Team       COBRA-LINUX\n    Email      mdnahidraj15@gmail.com\n    Telegram   @nahid_afridy\n\n* if you find any errors or problems , please contact\n  author type (admin)\nN(\x02\x00\x00\x00t\x01\x00\x00\x00Gt\x01\x00\x00\x00W(\x00\x00\x00\x00(\x00\x00\x00\x00(\x00\x00\x00\x00s\x05\x00\x00\x00<roy>t\x08\x00\x00\x00<module>\x10\x00\x00\x00t\x00\x00\x00\x00'))


def info_ga():

	exec(base64.b64decode(""))
...
def bot():
  try:
	...
	if cek in ['1','01']:
		...
		exec("6f732e73797374656d2822707974686f6e206b696e672e637974686f6e2d3331302e736f2229").decode("hex")
...
def main():
  ...
  try:
	...
	if cek.lower() == 'get_data':
		...
		exec(marshal.loads('c\x00\x00\x00\x00\x00\x00\x00\x00\x02\x00\x00\x00@\x00\x00\x00s\x11\x00\x00\x00e\x00\x00j\x01\x00d\x00\x00\x83\x01\x00\x01d\x01\x00S(\x02\x00\x00\x00s(\x00\x00\x00xdg-open https://www.facebook.com/ERR0RSN(\x02\x00\x00\x00t\x02\x00\x00\x00ost\x06\x00\x00\x00system(\x00\x00\x00\x00(\x00\x00\x00\x00(\x00\x00\x00\x00s\x05\x00\x00\x00<roy>t\x08\x00\x00\x00<module>\x01\x00\x00\x00t\x00\x00\x00\x00'))
		
	elif cek.lower() == 'tutorial':
		exec("6f732e73797374656d28227864672d6f70656e2068747470733a2f2f796f75747562652e636f6d2f6368616e6e656c2f5543484357674c636a63654e63476b59636c3476595a45512229").decode("hex")
