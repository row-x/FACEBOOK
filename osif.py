...
\033[1;95m    /_/ |_/  /_/  |_/_/ /_/  /___/  /_____/  \033[1;92m
   ...
   |      \033[1;91mPLEASE DON'T UES A RONG WORK      \033[1;92m|
   ------------------------------------------""")
		print (W + '   [' + G +'\033[1;93mOpen Source Information Facebook'+ W + ']')
		print (W + '   [' + G +'Show All Working List Type - (help) And Enter'+ W + ']')
		print (W + '   [' + G +'How to Ues ? type (tutorial) And Enter'+ W + ']')
		print (W + '   [' + G +'\033[1;93mContract Admin Type - (admin) And Enter'+ W + ']')
		print ' '
####################################################################
#		    Print In terminal
def show_program():
 ...
 ------------------------------------------------------
    ...
    Name       NAHID 'Open Source Information Facebook'
    CodeName   NAHID-AFRIDY
    version    full version
    Date       04/11/2022 09:35:12
    Team       COBRA-LINUX
...
def info_ga():
  ...
  -------------       -------------------------------------
   ...
   tutorial             This Tools How to Ues ? Seen The
                            Tutorial - type (tutorial)
   admin              Any Problem Contract Tools Owner
                           Type - (admin)
